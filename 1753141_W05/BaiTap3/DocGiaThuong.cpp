...
DocGiaThuong::DocGiaThuong(string id, string hoten, string ngayhethan) : DocGia(id, hoten, ngayhethan)
{
}

DocGiaThuong::DocGiaThuong(string id, string hoten, string ngayhethan, string gioitinh) : DocGia(id, hoten, ngayhethan, gioitinh)
{
}

DocGiaThuong::DocGiaThuong(string id, string hoten, string ngayhethan, string gioitinh, int sosachmuon) : DocGia(id, hoten, ngayhethan, gioitinh)
{
